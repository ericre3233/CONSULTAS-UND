...
def inserirconsulta(contador, cont, bot: DesktopBot, self: DesktopBot, contador_celulas_vazias=0, executation=None, config=None):
    if config is None:
...
def inserir(contador, cont, bot: DesktopBot, self: DesktopBot, contador_celulas_vazias=0, executation=None, config=None):
    ...
    contador = contador + 1
    inserirconsulta(contador, cont, bot=self, self=self, contador_celulas_vazias=contador_celulas_vazias)
